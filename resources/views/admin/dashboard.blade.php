          ...
          <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    ...
                    @endphp
                    <form action="{{ route('admin.dashboard') }}" method="GET" class="mb-3" id="filterForm">
                        <div class="row g-2">
                            <div class="col-md-3">
                    ...
                    <h2 class="form-text text-muted">
                        ...
                        untuk outlet: <strong>{{ $namaOutletTerpilih }}</strong>
                    </h2>                                   
                </div>            
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="small-box text-bg-primary">
                        ...
                        @if (request('outlet_id'))
                            <a href="{{ route('admin.datasales', ['id' => request('outlet_id')]) }}" 
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="small-box text-bg-danger">
                        ...
                        @if (request('outlet_id'))
                            <a href="{{ route('admin.expense', ['id' => request('outlet_id')]) }}" 
                                class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                More info <i class="bi bi-link-45deg"></i>
                            </a>
                        @endif
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="small-box text-bg-danger">
                        ...
                        @if (request('outlet_id'))
                            <a href="{{ route('admin.seduh', ['id' => request('outlet_id')]) }}" 
                                class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                More info <i class="bi bi-link-45deg"></i>
                            </a>
                        @endif
